...
public class EmailStepImpl {
	...
	public void will_be_able_to_see_the_email_address_displayed_in_e_mail_address_field(String username) {
		WebElement temp = driver.findElement(By.xpath("//*[@id=\"userinfocard\"]/div/div[2]/span"));
	   WebElement emailfield = new WebDriverWait(driver, Duration.ofSeconds(10)).until(ExpectedConditions.visibilityOf(temp));
