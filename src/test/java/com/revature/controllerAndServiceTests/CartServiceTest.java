...
public class CartServiceTest {
	...
	@Test
	public void getCartItemsReturnsNull() {
		/*this test is not a story since the 
		method it's testing is non-functional and handled by front end*/
		User user = new User();
		assertNull(cartService.getCartItems(user));
	}
}
